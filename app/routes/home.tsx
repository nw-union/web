...
import { DiscordIcon, GitHubIcon, YouTubeIcon } from "../components/Icons";
import {
...
const homeTerminalSequence: TerminalSequence = {
  steps: [
    ...
    { type: "element", elementId: "terminal-social" },
    { type: "element", delay: 800 }, // MEDIUM_DELAY
          ...
          <div className="my-4 mb-6 opacity-0" id="terminal-output-3">
            ...
            >
              <div className="flex flex-col gap-0.5">
                ...
                >
                  <DiscordIcon className="w-6 h-6 md:w-7 md:h-7 fill-current" />
                  <span>Discord</span>{" "}
                ...
                <a
                  ...
                  className="text-green-600 dark:text-green-400 no-underline flex items-center gap-2 py-1 transition-colors duration-300 hover:text-cyan-600 dark:hover:text-cyan-400 hover:underline"
                >
                  <YouTubeIcon className="w-6 h-6 md:w-7 md:h-7 fill-current" />
                  <span>YouTube</span>
                </a>
                <a
                  href="/github"
                  ...
                  className="text-green-600 dark:text-green-400 no-underline flex items-center gap-2 py-1 transition-colors duration-300 hover:text-cyan-600 dark:hover:text-cyan-400 hover:underline"
                >
                  <GitHubIcon className="w-6 h-6 md:w-7 md:h-7 fill-current" />
                  <span>GitHub</span>
                </a>
              </div>
            </div>
